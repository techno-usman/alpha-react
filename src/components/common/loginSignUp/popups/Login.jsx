...
import LoginSignUpLeftCol from '../left-coulmn';
import './login.css';
                            ...
                            <Row className="mt-5 mx-3">
                                <Col>
                                    <Row>
                                        ...
                                        <Col>
                                            <a href="#" onClick={onClose} className="for-back-col-2-login text-decoration-none">Back</a>
                                        </Col>
                                    </Row>
                                </Col>
                            ...
                            <div className="for-form-container-col-2-login">
                                ...
                                <Row>
                                    <Col className="text-center pt-4">
                                        <h1 className="text-before-singup">New to “Alpha Play”? <span className="singup-col-2-login" onClick={() => onClose({ popup: "login" })}>Sign Up</span></h1>
                                    </Col>
                                </Row>
                            </div>
                        </Col>
