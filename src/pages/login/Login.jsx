...
const Login = () => {
    return (
        <Container fluid>
            <Row>
                <Col lg={6} className="bg-for-col-1-login">
                    ...
                    <Row>
                        <Col>
                            <h4 class="double-comas-col-1-login">“</h4>
                            <p class="for-text-col-1-login">Lorem ipsum dolor sit amet, consectetur adipiscing elit. At neque tincidunt ac, a odio id arcu scelerisque. Nunc, ullamcorper enim amet donec euismod morbi malesuada quam. Augue massa </p>
                        </Col>
                    </Row>
                    <Row>
                        <Col xs={3}>
                            <h4 class="for-author-name-col-1-login">Irfan saeed</h4>
                        </Col>
                        <Col className="text-start">
                            <svg class="for-checkmark-col-1-login" width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Col className="bg-for-col-2-login">
                    <Row className="mt-5 mx-3">
                        <Col>
                            <Row>
                                ...
                                <Col>
                                    <h1 class="for-back-col-2-login">Back</h1>
                                </Col>
                            </Row>
                        </Col>
                        <Col className="text-end">
                    ...
                    <div class="for-form-container-col-2-login">
                        <h1 class="for-login-col-2-login">Login</h1>
                        <p class="form-text-col-2-login">For the purpose of regulation, your details are required.</p>
                        <form>
                            <div class="mb-4">
                            ...
                            <div class="mb-4 form-check">
                                ...
                                <Row>
                                    ...
                                    <Col className="text-end">
                                        <a href="#" class="for-forget-pass-col-2-login">Forget Password?</a>
                                    </Col>
                                </Row>
                            </div>
                        ...
                        <Row>
                            <Col className="text-center pt-4">
                                <h1 class="text-before-singup">New to “Alpha Play”? <span class="singup-col-2-login">Sign Up</span></h1>
                            </Col>
                        </Row>
                    </div>
                </Col>
